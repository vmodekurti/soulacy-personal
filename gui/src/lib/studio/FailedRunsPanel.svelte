...
<style>
  ...
  .fr-muted { font-size: .84rem; color: var(--text-dim, var(--sl-text-faint)); }
  .fr-error {
  ...
  .fr-chip {
    ...
    background: transparent; color: var(--text-dim, var(--sl-text-faint));
  ...
  .fr-cat { padding: 1px 7px; border-radius: 999px; font-size: .68rem; background: color-mix(in srgb, var(--text-dim, var(--sl-text-faint)) 20%, transparent); }
  ...
  .fr-msg { font-size: .78rem; color: var(--text-dim, var(--sl-text-faint)); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .fr-when { font-size: .72rem; color: var(--text-dim, var(--sl-text-faint)); }

  .fr-detail { display: flex; flex-direction: column; gap: 8px; min-width: 0; }
  .fr-cat-hint { font-size: .82rem; color: var(--text-dim, var(--sl-text-faint)); }
  .fr-repeat {
    margin: 0; padding: 6px 8px; border-radius: 6px; font-size: .8rem;
    background: color-mix(in srgb, var(--warn, #f0ad4e) 10%, transparent);
  }
  .fr-label { font-size: .7rem; text-transform: uppercase; letter-spacing: .04em; color: var(--text-dim, var(--sl-text-faint)); }
  .fr-cause {
    display: flex; flex-direction: column; gap: 2px;
