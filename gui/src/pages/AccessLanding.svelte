<script>
  ...
  export let signupEnabled = false
  ...
  <section class="hero">
    <div class="hero-copy">
      ...
      <div class="access-grid" aria-label="Choose how to sign in">
        {#if signupEnabled}
        <a class="access-card primary signup-link" href="/signup">
          <span class="card-icon" aria-hidden="true">＋</span>
          <span><strong>Create a workspace</strong><small>Start a secure organization with your verified identity</small></span>
        </a>
        {/if}
