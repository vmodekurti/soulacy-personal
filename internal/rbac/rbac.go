...
var defaultPolicy = map[string]map[string]map[string]bool{
	RoleOwner: {
		...
		ResourceProviders:   {ActionRead: true, ActionWrite: true, ActionSet: true},
	...
	RoleDeveloper: {
		...
		// Developers may choose from workspace-approved providers and models,
		// but cannot add endpoints, change API keys, or delete providers.
		ResourceProviders:   {ActionRead: true, ActionSet: true},
