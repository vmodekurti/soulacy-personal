...
func TestIsSideEffectingTool(t *testing.T) {
	sideEffecting := []string{"shell_exec", "run_script", "install_library", "package_install", "mcp_register_remote", "write_file", "download_file", "http_request", "mcp__playwright__navigate", "plugin__x__do"}
