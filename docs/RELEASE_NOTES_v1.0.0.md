...
Docker path: `docker run -d -p 9000:18789 ghcr.io/vmodekurti/soulacy-personal:v1.0.0`

See [README.md](https://github.com/vmodekurti/soulacy-personal#readme) for the full
install matrix.
...
- Issues: <https://github.com/vmodekurti/soulacy-personal/issues>
- Security: <mailto:security@soulacy.dev> (see `SECURITY.md`)
- Discussion: <https://github.com/vmodekurti/soulacy-personal/discussions>
